...
public class HashedWheelTimer implements Timer {
	 ...
	 *
	 * @param threadFactory
	 *            a {@link ThreadFactory} that creates a background {@link Thread}
	 *            which is dedicated to {@link TimerTask} execution.
	 * @param tickDuration
	 ...
	 *            {@link RejectedExecutionException} being thrown. No maximum
	 *            pending timeouts limit is assumed if this value is 0 or negative.
	 * @throws NullPointerException
	 *             if either of {@code threadFactory} and {@code unit} is
	 *             {@code null}
	 * @throws IllegalArgumentException
	 *             if either of {@code tickDuration} and {@code ticksPerWheel} is
	 *             &lt;= 0
	 */
	public HashedWheelTimer(ThreadFactory threadFactory, long tickDuration, TimeUnit unit, int ticksPerWheel,
